...
ActiveRecord::Schema[8.1].define(version: 2026_06_01_000099) do
  ...
  create_table "personal_projects", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["discarded_at"], name: "index_personal_projects_on_discarded_at"
    t.index ["user_id"], name: "index_personal_projects_on_user_id"
  end
  ...
  create_table "user_roles", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index "user_id, COALESCE(organization_id, 0), role_id, COALESCE(route_group, '')", name: "index_user_roles_on_user_org_role_group", unique: true
  ...
  add_foreign_key "personal_projects", "users"
